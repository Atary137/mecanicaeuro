...
export const metadata: Metadata = {
  ...
  keywords: ['mecânica São José dos Pinhais', 'oficina mecânica Paraná', 'Mecânica Euro', 'diagnóstico computadorizado'],
  authors: [{ name: 'Mecânica Euro' }],
  creator: 'Mecânica Euro',
  publisher: 'Mecânica Euro',
  alternates: { canonical: 'https://mecanicaeuro.com.br' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Mecânica Euro | Especialistas em Nacionais e Importados',
    description: 'Oficina especializada em veículos nacionais e importados desde 2008.',
    url: 'https://mecanicaeuro.com.br',
    siteName: 'Mecânica Euro',
    locale: 'pt_BR',
    type: 'website',
    images: [{ url: '/images/logo-euro.png', width: 800, height: 600 }],
  },
  verification: {
